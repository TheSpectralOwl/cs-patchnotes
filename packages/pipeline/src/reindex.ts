...
/**
 * @deprecated Transitional prototype export retained for exact-reference
 * removal. No runtime command or test calls this line-based projection.
 */
